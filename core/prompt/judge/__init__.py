...
3. หากมีข้อยกเว้น เงื่อนไข หรือข้อควรระวังตามระเบียบ ให้ระบุให้ครบถ้วน
4. ระบุเฉพาะมาตราหรือข้อระเบียบที่มีข้อมูลสนับสนุนในเนื้อหาที่ให้มาเท่านั้น ห้ามคาดเดา
...
{{
    ...
    "category": ["หมวดหมู่หรือประเด็นการจัดซื้อจัดจ้าง เช่น การกำหนดคุณลักษณะเฉพาะ"],
